  ...
  async addExpenseCategory(){
    ...
    justifyContent: 'space-around',borderBottomWidth:1,borderColor:colors.primaryLight}} >
           <View style={{flax:1,width: '90%',padding:15}} >
                 ...
                 <TouchableOpacity disabled={this.state.isDisabled}  onPress={() => this.addExpenseCategory()} >
                       <Image
                        resizeMode="contain"
                        source={saveIcon}
                       />
       ...
       <View style={{paddingTop:30}}>
            ...
            <View style={{padding:15,paddingTop:5}}>
                <TouchableOpacity disabled={this.state.isDisabled}  onPress={() => this.addExpenseCategory()}  style={{justifyContent:"center",alignItems:'center',backgroundColor:colors.primaryLight,borderRadius:2,padding:10}}>
...
export default connect(mapStateToProps, mapDisptachToProps)(ExpenseCategorynewScreen)
