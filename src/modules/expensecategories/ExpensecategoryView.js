...
const nextIcon = require('../../../assets/images/next.png');
 ...
 class expensecategoryScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  componentDidMount() {
       this._unsubscribe = this.props.navigation.addListener('focus', () => {
                 this.props.setHeaderRightIconShow('Add Expense Category');
  ...
  editCustomer(data){
     ...
     this.props.navigation.navigate('Edit Expense Category')
  }
      ...
      this.setState({ fetching_from_server: true }, () => {
        NetInfo.fetch().then(state => {
          if(state.isConnected) {
            console.log(CONSTANTS.ALL_EXPENSES_CATEGORY_API+'?page=' + this.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
            fetch(CONSTANTS.ALL_EXPENSES_CATEGORY_API+'?page=' + this.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
...
export default connect(mapStateToProps, mapDisptachToProps)(expensecategoryScreen)
