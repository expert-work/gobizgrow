...
import NetInfo from "@react-native-community/netinfo";
 ...
 class ExpenseseditScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
          company_id:'',
          notificationTitle:'',      
          notificationMessage:'',
          expense_date:this.props.editData.expense_date,
  ...
  async editExpenses(){
    ...
    justifyContent: 'space-around',borderBottomWidth:1,borderColor:colors.primaryLight}} >
           <View style={{flax:1,width: '90%',padding:15}} >
                 ...
                 <TouchableOpacity disabled={this.state.isDisabled}  onPress={() => this.editExpenses()} >
                       <Image
                        resizeMode="contain"
                        source={saveIcon}
                       />
      ...
      <View style={{ borderColor: colors.primaryLight,borderWidth: 1,borderRadius:2,height:40}}> 
       ...
       <RNPickerSelect
            ...
            value={this.state.expense_category_id}
        ...
        />
            ...
            <View style={{padding:15,paddingTop:3}}>
              ...
              <View style={{padding:15,paddingTop:5}}>
                <TouchableOpacity disabled={this.state.isDisabled}  onPress={() => this.editExpenses()}  style={{justifyContent:"center",alignItems:'center',backgroundColor:colors.primaryLight,borderRadius:2,padding:10}}>
...
export default connect(mapStateToProps, mapDisptachToProps)(ExpenseseditScreen)
