...
import NetInfo from "@react-native-community/netinfo";
 ...
 class UnitnewScreen extends Component {
  constructor() {
    super();
    this.state = {
          name:'',
  ...
  async addUnit(){
    try {
           ...
           var user=  await this.addUnitApiCall();
    ...
    justifyContent: 'space-around',borderBottomWidth:1,borderColor:colors.primaryLight}} >
           <View style={{flax:1,width: '90%',padding:15}} >
                 ...
                 <TouchableOpacity disabled={this.state.isDisabled}  onPress={() => this.addUnit()} >
                       <Image
                        resizeMode="contain"
                        source={saveIcon}
                       />
       ...
       <View style={{paddingTop:30}}>
            ...
            <View style={{padding:15,paddingTop:5}}>
                <TouchableOpacity disabled={this.state.isDisabled}  onPress={() => this.addUnit()}  style={{justifyContent:"center",alignItems:'center',backgroundColor:colors.primaryLight,borderRadius:2,padding:10}}>
...
export default connect(mapStateToProps, mapDisptachToProps)(UnitnewScreen)
