...
const crossIcon = require('../../../assets/images/cross.png');
 ...
 class EstimateDraftScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
      ...
      this.setState({ fetching_from_server: true }, () => {
        NetInfo.fetch().then(state => {
          if(state.isConnected) {
            console.log(CONSTANTS.ALL_ESTIMATES_SENT_API+'?page=' + this.state.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
            fetch(CONSTANTS.ALL_ESTIMATES_DRAFT_API+'?page=' + this.state.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
...
export default connect(mapStateToProps, mapDisptachToProps)(EstimateDraftScreen)
