 ...
 class CategoryScreen extends Component {
  ...
  componentDidMount() {
       this._unsubscribe = this.props.navigation.addListener('focus', () => {
                 this.props.setHeaderRightIconShow('Add Category');
  ...
  editCustomer(data){
     ...
     this.props.navigation.navigate('Edit Category')
  }
...
export default connect(mapStateToProps, mapDisptachToProps)(CategoryScreen)
