 ...
 class UnitScreen extends Component {
  ...
  componentDidMount() {
       this._unsubscribe = this.props.navigation.addListener('focus', () => {
                this.props.setHeaderRightIconShow('Add Unit');
  ...
  editCustomer(data){
     ...
     this.props.navigation.navigate('Edit Unit')
      ...
      this.setState({ fetching_from_server: true }, () => {
        NetInfo.fetch().then(state => {
          if(state.isConnected) {
            console.log(CONSTANTS.ALL_UNITS_API+'?page=' + this.state.offset +'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
            fetch(CONSTANTS.ALL_UNITS_API+'?page=' + this.state.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
...
export default connect(mapStateToProps, mapDisptachToProps)(UnitScreen)
