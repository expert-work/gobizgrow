...
const nextIcon = require('../../../assets/images/next.png');
 ...
 class InvoiceDueScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  loadMoreData = () => {
    if (!this.state.fetching_from_server && !this.state.isListEnd) {
      ...
      this.setState({ fetching_from_server: true }, () => {
        console.log(CONSTANTS.ALL_INVOICES_DUE_API+'?page=' + this.state.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
        fetch(CONSTANTS.ALL_INVOICES_DUE_API+'?page=' + this.state.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
...
export default connect(mapStateToProps, mapDisptachToProps)(InvoiceDueScreen)
