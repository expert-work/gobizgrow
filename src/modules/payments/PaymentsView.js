 ...
 class PaymentsScreen extends Component {
  ...
  componentDidMount() {
       this._unsubscribe = this.props.navigation.addListener('focus', () => {
                this.props.setHeaderRightIconShow('Add Payment');
  ...
  editCustomer(data){
     ...
     this.props.navigation.navigate('Edit Payment')
  ...
  loadMoreData = () => {
    if (!this.state.fetching_from_server && !this.state.isListEnd) {
      ...
      this.setState({ fetching_from_server: true }, () => {
        console.log(CONSTANTS.ALL_PAYMENTS_API+'?page=' + this.state.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
        fetch(CONSTANTS.ALL_PAYMENTS_API+'?page=' + this.state.offset+'&company_id='+this.props.userInfo.company_id+'&q='+this.state.q)
...
export default connect(mapStateToProps, mapDisptachToProps)(PaymentsScreen)
